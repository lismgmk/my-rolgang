...
const rollerСonveyors = () => {
  const rollerСonveyorses = getListPage(`rollerConveyors/_index.md`);
  const { title, meta_title, description } = rollerСonveyorses.frontmatter;
  const technologies: techonoliges[] = getSinglePage("rollerConveyors");
...
export default rollerСonveyors;
